...
const AboutUs = () => {
	...
	return (
		<div className="md:flex gap-6 justify-center items-center py-[50px] md:py-[130px]">
			<motion.div
				...
				<img
					className="w-1/2 md:w-2/5 mx-auto rounded-xl"
			...
			<div className={`md:w-1/2 pt-24 md:pb-5 ${isDarkMode ? "text-white" : "text-black"}`}>
				<h2 className="text-[40px] font-cinzel font-bold text-center">About Us</h2>
